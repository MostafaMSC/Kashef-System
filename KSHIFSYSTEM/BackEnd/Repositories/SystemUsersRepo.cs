...
//        public SystemUsersRepo(ApplicationDbContext db)
//        {
//        }
...
//            var User = await _userManager.FindByIdAsync(UserId);
//            var UserRole = await _db.UserRoles.FirstOrDefaultAsync(a => a.UserId == UserId);
//            if (UserRole.RoleId == "update")
//            {
//                await _userManager.RemoveFromRoleAsync(User, "update");
//                var RoleRecored = await _db.Roles.FirstOrDefaultAsync(a => a.Name == "update");
//                await _userManager.AddToRoleAsync(User, "admin");
//                UserRole.RoleId = RoleRecored.Id;
//                _db.UserRoles.Update(UserRole);
//                await _db.SaveChangesAsync();
...
//            }
//            else if (UserRole.RoleId == "update")
//            {
//                await _userManager.RemoveFromRoleAsync(User, "update");
//                var RoleRecored = await _db.Roles.FirstOrDefaultAsync(a => a.Name == "update");
//                await _userManager.AddToRoleAsync(User, "View");
...
//                await _userManager.RemoveFromRoleAsync(User, "admin");
//                var RoleRecored = await _db.Roles.FirstOrDefaultAsync(a => a.Name == "admin");
//                await _userManager.AddToRoleAsync(User, "update");
//                UserRole.RoleId = RoleRecored.Id;
//                _db.UserRoles.Update(UserRole);
//                await _db.SaveChangesAsync();
//                return true;
